...
<section class="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-brand-black py-16">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-6 text-center">
        {{-- Service Icon --}}
        <div class="w-16 h-16 bg-brand-blue/10 border border-brand-blue/20 rounded-2xl flex items-center justify-center mx-auto mb-8" data-aos="fade-down">
        ...
        <h1 class="font-playfair text-4xl md:text-6xl font-bold leading-tight text-white mb-6" data-aos="fade-up">
            {!! $service['hero_title'] !!}
        </h1>
    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div data-aos="fade-right">
                ...
                <h2 class="font-playfair text-3xl md:text-4xl font-bold text-white mt-3 mb-6">What's Included</h2>
                <p class="font-inter text-brand-muted text-base leading-relaxed mb-8">
                    {{ $service['long_description'] }}
                </p>
                <div class="flex flex-wrap gap-2">
                    @foreach($service['technologies'] as $tech)
                    <span class="bg-brand-black border border-white/10 text-brand-muted font-grotesk text-xs px-4 py-1.5 rounded-full hover:border-brand-blue/40 hover:text-white transition">{{ $tech }}</span>
                    @endforeach
                </div>
            </div>
            ...
            <div class="space-y-4" data-aos="fade-left">
                ...
                <div class="bg-brand-card border border-white/5 rounded-2xl p-6 hover:border-brand-blue/30 transition group" data-aos="fade-left" data-aos-delay="{{ $index * 80 }}">
